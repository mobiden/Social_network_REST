...
class Users_likes(models.Model):
    ...
    likes = models.CharField(max_length=1, choices=STATUS_CHOISES,
                              blank=True,
                              null=True,
                            )
    class Meta:
        constraints=[models.UniqueConstraint(fields=["posts", "user"],
                                            name="only_one_like")]
